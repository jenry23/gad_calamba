...
class ImportGads implements ToModel, WithHeadingRow, WithCalculatedFormulas, WithChunkReading, WithCustomCsvSettings, SkipsEmptyRows, SkipsOnError, WithValidation
{
    ...
    public function model(array $row)
    {
        $result = [
            ...
            "poltical_province_registered_id" => $this->convertStringToID(Province::class, 'province_name', $row["province_registered_not_required_dropdown_option"]),
            "poltical_city_registered_id" => $this->convertStringToID(City::class, 'city_name', $row["city_municipality_registered_not_required_dropdown_option"]),
