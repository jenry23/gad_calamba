            ...
            foreach ($data_row as $row) {
                DB::transaction(
                    function () use ($row, $household_number) {
                        ...
                        $gad->household_no = $household_number;
                        ...
                        $gad->political_brgy_registered = $this->convertStringToID(Barangay::class, 'barangay_name', $row['brgy_registered_not_required_dropdown_option']) ?? null;
                        ...
                        if ((int) $age > 59) {
                            $this->addGadDetailsItem($gad_id, Sector::class, 2, 'sector');
                        }
