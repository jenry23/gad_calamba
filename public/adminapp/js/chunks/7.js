  ...
  data: function data() {
    ...
    return {
      ...
      json_fields: (_json_fields = {
        ...
        "Country of Rel. No. 1": ' '
      }, _defineProperty(_json_fields, "OFW Relative No. 1 (as related to family head)", ' '), _defineProperty(_json_fields, "Country of Rel. No. 2", ' '), _defineProperty(_json_fields, "OFW Relative No. 2 (as related to family head)", ' '), _defineProperty(_json_fields, "Beneficiary? (Any Member of the Family). YES/NO", ' '), _defineProperty(_json_fields, "Highest Educational Attainment", "educational_attaintment_name"), _defineProperty(_json_fields, "Educational Status", "educational_status_name"), _defineProperty(_json_fields, "Last School Attended", "last_school_attended"), _defineProperty(_json_fields, "Government Educational Assistance #1", "government_assistance_name"), _defineProperty(_json_fields, "Government Educational Assistance #2", ' '), _defineProperty(_json_fields, "Soft Skills #1", ' '), _defineProperty(_json_fields, "Soft Skills #2", ' '), _defineProperty(_json_fields, "Hard Skills #1", ' '), _defineProperty(_json_fields, "Hard Skills #2", ' '), _defineProperty(_json_fields, "Hobbies  #1", ' '), _defineProperty(_json_fields, "Hobbies  #2", ' '), _defineProperty(_json_fields, "Sports #1", ' '), _defineProperty(_json_fields, "Sports #2", ' '), _defineProperty(_json_fields, "Ethnicity No. 01", 'Tagalog'), _defineProperty(_json_fields, "Religion (Catholic:test, Iglesia ni Cristo:test, etc)", ' '), _defineProperty(_json_fields, "Sector No. 01", "sector_name"), _defineProperty(_json_fields, "Sector No. 02", ' '), _defineProperty(_json_fields, "Province Registered", "political_province_registered"), _defineProperty(_json_fields, "City/ Municipality Registered", "political_city_registered"), _defineProperty(_json_fields, "House Ownership", "house_ownership_names"), _defineProperty(_json_fields, "House Type", "house_type_names"), _defineProperty(_json_fields, "House Make", "house_make_names"), _defineProperty(_json_fields, "No. of Nuclear Family in Household", "no_nuclear_family_household_id"), _defineProperty(_json_fields, "No. of Bedrooms", "no_bedrooms_id"), _defineProperty(_json_fields, "No. of  CRs", "no_cr_id"), _defineProperty(_json_fields, "Utilities No. 01", "gad_utilities_no1"), _defineProperty(_json_fields, "Utilities No. 02", "gad_utilities_no2"), _defineProperty(_json_fields, "Utilities No. 03", "gad_utilities_no3"), _defineProperty(_json_fields, "Utilities No. 04", "gad_utilities_no4"), _defineProperty(_json_fields, "Appliances No. 01", "gad_appliances_no1"), _defineProperty(_json_fields, "Appliances No. 02", "gad_appliances_no2"), _defineProperty(_json_fields, "Appliances No. 03", "gad_appliances_no3"), _defineProperty(_json_fields, "Appliances No. 04", "gad_appliances_no4"), _defineProperty(_json_fields, "Vehicles No. 01", "vehicles_name"), _defineProperty(_json_fields, "Vehicles No. 02", ' '), _defineProperty(_json_fields, "Full Immunization (YES, Public Hosp/ Center YES, Private Hosp/ Clinic, NO)", ' '), _defineProperty(_json_fields, "Covid 19 Test (No COVID Test, Tested Positive for COVID19, Tested Negative for COVID19)", ' '), _defineProperty(_json_fields, "Date of 1st Dosage Covid 19 Vaccination", ' '), _defineProperty(_json_fields, "BRAND", ' '), _defineProperty(_json_fields, "Date of 2ndt Dosage Covid 19 Vaccination", ' '), _defineProperty(_json_fields, "BRAND", ' '), _defineProperty(_json_fields, "Pregnancy Age", ' '), _defineProperty(_json_fields, "With Prenatal Check up (YES, Public Hosp/ Center YES, Private Hosp/ Clinic, NO)", ' '), _defineProperty(_json_fields, "With Postnatal Check up (YES, Public Hosp/ Center YES, Private Hosp/ Clinic, NO)", ' '), _defineProperty(_json_fields, "Maintaining  Medicine No. 01 ", "medicine_name"), _defineProperty(_json_fields, "Maintaining Medicine No. 01 ", ' '), _defineProperty(_json_fields, "Organizations Involved No. 01", "organization_name"), _defineProperty(_json_fields, "Organizations  Involved No. 02", ' '), _defineProperty(_json_fields, "Barangay Residence Year", "barangay_residence_year"), _defineProperty(_json_fields, "Calamba Residence Year", "no_of_years_in_calamba"), _defineProperty(_json_fields, "REMARKS", "remarks"), _json_fields),
      json_data: [],
      json_meta: [[{
        key: "charset",
        value: "utf-8"
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])('ReportsSingle', ['searchData', 'fetchCreateData', 'resetState', 'setBarangay', 'setPurok', 'setSitio', 'setSector', 'setQuery', 'setAgeTo', 'setGender', 'setAgeFrom'])), {}, {
    ...
    submitForm: function submitForm() {
      ...
      this.searchData().then(function (response) {
        _this.json_data = response.data.meta.all_gads;
