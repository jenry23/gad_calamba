<template>
	<div class="container">
		<div class="card" style="width: 63rem">
								...
								<div class="barangay-body">
									...
									<div class="container" style="margin-top: -7%">
										<div class="barangay-body-paragraph">
											...
											<div class="row">
												<div class="col-md-8">
													...
													<div>
														...
														<b style="margin-right: 0px">:</b><b> {{ data.age }}</b>
													</div>
													<div>
														<b style="margin-right: 108px">Civil Status</b>
														<b style="margin-right: 0px">:</b><b> {{ data.civil_status }}</b>
													</div>
													<div>
											...
											<!-- <p class="text-justify">
												This certification is valid for one (1) year from the date of
												issuance.
											</p> -->
											<p>
			...
			<div class="footer">
				<img src="/transaction/foote_seal.png" width="100%" height="20%" />
			</div>
		</div>
	</div>
</template>
