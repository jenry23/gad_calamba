                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-success card-header-icon">
                            ...
                            <h4 class="card-title">
                                Create
                                <strong>Barangay Sanggunnian</strong>
                            </h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    >
                                        <label class="bmd-label-floating required">Barangay Sanggunian Category</label>
                                        <v-select
...
export default {
    ...
    methods: {
        ...mapActions('BarangaySanggunianSingle', ['storeData', 'fetchCreateData', 'resetState', 'setBarangayName', 'setBarangayID', 'setBarangayCategoryID']),
