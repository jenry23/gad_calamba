    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <ul class="nav nav-tabs d-none" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#educational"
                        >educational</a
                    >
                </li>
                <li class="nav-item">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        <label
                                            >Relation To Main Household</label
                                        >
                                        <input
                                            type="text"
                                            class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            :value="
                                                entry.educational_attaintment_name
                                            "
                                        />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            :value="
                                                entry.government_assistance_name
                                            "
                                        />
                                    </div>
                                </div>
