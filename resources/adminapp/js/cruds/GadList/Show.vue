										...
										<div class="col-md-6">
											<div class="pull-left">
												<h3
													...
													"
												>
													<b style="text-transform: uppercase; margin-right: 100px;font-weight: 900;">City Government of Calamba</b
													><br />
													<b style="text-transform: uppercase;font-weight: 900;"
														>City population management office</b
													><br />
													<b style="text-transform: uppercase; margin-right: 240px;font-weight: 900;"
														>Household Profile</b
													>
													<p style="font-family: Lora; margin-right: 385px;font-style: italic">e-Certificate</p>
												</h3>
										...
										<div class="col-md-3 mt-4">
											<table class="table-bordered" style="background-color:#F0F8FF !important;">
												...
												<tr>
													...
													<td v-if="lists.second_data.sitio">{{ lists.second_data.sitio.sitio_name }}</td>
													<td v-else></td>
												</tr>
											</table>
										</div>
